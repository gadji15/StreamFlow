...
export default function ConfirmationEmailPage() {
  ...
  return (
    <main className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-12 bg-background">
      <div className="w-full max-w-md bg-zinc-900 shadow-lg rounded-xl p-8 flex flex-col items-center gap-6 border border-zinc-800">
        ...
        <h1 className="text-2xl font-bold text-center text-zinc-100">Confirmez votre adresse e-mail</h1>
