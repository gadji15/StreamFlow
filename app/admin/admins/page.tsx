...
/* 
  Correction:
  - Fichier nettoyé pour ne contenir qu'une seule déclaration fonctionnelle AdminsPage
  - Toutes les déclarations d'état (setLoading, setSuccessMessage, etc.) sont uniques dans le fichier
  - Aucun doublon de composant ni conflits d'état
  - La version conservée est celle qui gère la logique de rôles admin/super_admin, profils, user_roles, etc.
*/" : "Ajouter"}
                    </Button>
                  </DialogFooter>
                </DialogContent>
