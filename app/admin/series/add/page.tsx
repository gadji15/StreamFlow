...
export default function AdminAddSeriesPage() {
  ...
  // ...TOUS les handlers ci-dessus doivent rester ainsi, NE DOIVENT PAS CONTENIR de return JSX...

  // ...puis le seul return JSX du composant principal...
  return (
    <div>
      <div className="flex items-center mb-6">
        <Button
      ...
      {/* ...le reste du JSX, y compris le formulaire TMDB et Tabs... */}
    </div>
  );
}

// (Veille à ne PAS avoir d'autre return JSX dans d'autres fonctions, ni de { return ( ... ) } dans les handlers !)
