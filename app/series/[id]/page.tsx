...
export default function SeriesDetailPage() {
  ...
  const handleWatchFirst = () => {
    ...
    const seasonEpisodes = episodes.filter(ep => ep.season_id === selectedSeasonId);
          ...
          {seasons.map((season) => (
            <SidebarMenuItem key={season.id}>
              ...
              >
                ...
                {season.title && (
                  <span className="truncate text-xs text-gray-400 ml-1">{season.title}</span>
                )}
              </SidebarMenuButton>
            </SidebarMenuItem>
          ))}
          ...
          <div className="flex-1 flex flex-col gap-6 w-full">
            ...
            <div className="sticky top-0 z-30 bg-background bg-opacity-80 backdrop-blur border-b border-gray-700">
              <Tabs defaultValue="overview">
                <TabsList className="flex w-full overflow-x-auto border-b border-gray-700">
                ...
                <TabsContent value="seasons" className="pt-6">
                  <div className={cn("flex gap-8", isMobile ? "flex-col" : "flex-row")}>
                    ...
                    <div className={cn(isMobile ? "w-full" : "w-1/4 min-w-[11rem]")}>
                      {isMobile ? renderSeasonsNavMobile() : renderSeasonsNavDesktop()}
                    </div>
                    {/* Episodes */}
                ...
                <TabsContent value="casting" className="pt-6">
                  ...
                  {series.tmdb_id ? (
                    <CastingGrid tmdbId={series.tmdb_id} type="tv" fallbackCast={series.cast} />
