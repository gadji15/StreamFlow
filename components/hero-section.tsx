...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute top-0 left-0 bottom-0 z-[60] w-12 sm:w-24 md:w-32"
        style={{
          background:
      ...
      <div
        className="pointer-events-none absolute top-0 right-0 bottom-0 z-[60] w-12 sm:w-24 md:w-32"
        style={{
          background:
